...
function Signup() {
  ...
  const [
    isCompanyRegistrationNumVerified,
    setIsCompanyRegistrationNumVerified,
  ] = useState(false);
  ...
  const handleSignup = async (e) => {
    ...
    setIsLoading(true);
    const userTypeValue =
      isBusinessUser && isCompanyRegistrationNumVerified ? "사업자" : "일반";
    if (
      !isUserIdValid ||
      !isUsernameValid ||
      !isPasswordValid ||
            ...
            <form className={style.signup_form} onSubmit={handleSignup}>
              <div className={style.input_wrapper}>
                <div className={style.title_input}>
                  ...
                  <div className={style.id_button}>
                    ...
                    <div
                      onClick={checkUserId}
                      className={style.check_id_button}
                    >
                      아이디검사
                    </div>
                  </div>
                ...
                <div className={style.error_message_area}>
                  {useridTouched && !isUserIdValid && (
                    <div className={style.error_message}>
                      아이디를 영문, 숫자를 조합하여 3자리 이상으로 설정해
                      주세요.
                    </div>
                  )}
                  ...
                  {useridTouched &&
                    ...
                    isUserIdValid &&
                    isUserIdUnique === null && (
                      <div className={style.prompt_message}>
                        아이디 검사를 수행하세요.
                      </div>
                    )}
                  {useridTouched &&
              ...
              <div className={style.input_wrapper}>
                ...
                <div className={style.error_message_area}>
                  ...
                  {isPasswordValid && passwordTouched && !isPasswordComplex && (
                    <div className={style.error_message}>
                      비밀번호는 숫자, 영문, 특수문자를 혼합하여 8자리 이상으로
                      설정해주세요.
                    </div>
                  )}
                  {passwordTouched && isPasswordComplex && (
                    <div className={style.success_message}>
                      사용 가능한 비밀번호입니다.
                    </div>
                  )}
              ...
              <div className={style.email_wrapper}>
                ...
                <p className={style.email_how}>
                  이메일은 아이디, 비밀번호 찾기에 활용됩니다. 실제 사용하는
                  이메일을 입력해주세요.
                </p>
                <div className={style.error_message_area}>
                  ...
                  <div className={style.sms_button}>
                    ...
                    {isSmsSend && (
                      <div className={style.sms_verification}>
                        <input
                          className={style.sms_input}
                          placeholder="인증번호를 입력하세요."
                          value={verificationCode}
                          onChange={(e) => setVerificationCode(e.target.value)}
                        />
                        <span className={style.timer}>
                          {timer != null ? formatTimer() : ""}
                        </span>{" "}
                        {/* 타이머 표시 */}
                        <div
                          onClick={handleVerificationSubmit}
                          className={style.submit_code_button}
                        >
                          제출
                        </div>
                      </div>
                  ...
                  <div className={style.title_input}>
                    ...
                    <div className={style.address_area}>
                      ...
                      <input
                        ...
                        className={style.signup_input_detail}
                      />
                    </div>
                  </div>
                </div>
