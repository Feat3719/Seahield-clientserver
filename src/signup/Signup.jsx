...
function Signup() {
    ...
    const handleSignup = async (e) => {
        e.preventDefault();
        const userTypeValue =
            isBusinessUser && isCompanyRegistrationNumVerified
                ? "사업자"
                : "일반";
        if (
            !isUserIdValid ||
