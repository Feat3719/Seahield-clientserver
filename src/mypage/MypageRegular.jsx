        ...
        <div className={style.contract_title}>
          <table className={style.my_table} style={{ left: "-18vw" }}>
            <thead className={style.contract_title}>
              <tr>
                <td style={{ width: "45vw" }} className={style.my_td}>
                  {" "}
                  사용자_종류{" "}
                </td>
                <td
    ...
    // case 2:
      ...
      return (
        <div>
          ...
          <button onClick={updateUserInfo} disabled={!isPwdValid}>
            수정 완료
          </button>
          {!isPwdValid && userPwd && (
            <p style={{ color: "red" }}>
              비밀번호는 8자 이상이며, 최소 하나의 문자, 숫자 및 특수 문자를
              포함해야 합니다.
            </p>
          )}
        </div>
        ...
        <div className={style.my_form}>
          ...
          <div className={style.my_info}>
            ...
            <div className={style.my_input_wrapper_1}>
              ...
              <button className={style.transBtn} onClick={() => changeScene(1)}>
                1번 장면으로
              </button>
              <button className={style.transBtn} onClick={() => changeScene(2)}>
                2번 장면으로
              </button>
